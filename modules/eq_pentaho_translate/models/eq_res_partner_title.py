...
class eq_res_partner_title(models.Model):
    """

        eq_title_de -> Das Feld Title mit einem DE Text
        eq_title_en -> Das Feld Title mit einem EN Text
    """

    _inherit = "res.partner.title"

    eq_title_de = fields.Char(compute = '_set_all_fields_de')
    eq_title_en = fields.Char(compute = '_set_all_fields_en')
    ...
    def _set_all_fields_de(self):
        ...
        for rec in self:
            ...
            rec.eq_title_de = localized_rec.name
    ...
    def _set_all_fields_en(self):
        ...
        for rec in self:
            ...
            rec.eq_title_en = localized_rec.name